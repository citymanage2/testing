...
export default function EstimateView() {
    ...
    return (_jsxs("div", { style: { padding: 24, maxWidth: 1400, margin: '0 auto' }, children: [_jsxs("div", { style: { display: 'flex', alignItems: 'flex-start', gap: 12, marginBottom: 14, flexWrap: 'wrap' }, children: [_jsxs("div", { style: { flex: 1, minWidth: 220 }, children: [editingName ? (_jsx("input", { ref: nameRef, value: taskName, onChange: e => setTaskName(e.target.value), onBlur: saveName, onKeyDown: e => { if (e.key === 'Enter')
                                    ...
                                    setEditingName(false); }, style: { fontSize: 20, fontWeight: 600, border: '1px solid #1976d2', borderRadius: 4, padding: '3px 8px', width: '100%' } })) : (_jsxs("h2", { style: { margin: 0, cursor: 'pointer', display: 'inline-flex', alignItems: 'center', gap: 8 }, onClick: () => setEditingName(true), title: "\u041D\u0430\u0436\u043C\u0438\u0442\u0435 \u0447\u0442\u043E\u0431\u044B \u043F\u0435\u0440\u0435\u0438\u043C\u0435\u043D\u043E\u0432\u0430\u0442\u044C", children: [taskName || `Смета ${id?.slice(0, 8)}`, _jsx("span", { style: { fontSize: 14, color: '#aaa' }, children: "\u270E" })] })), _jsxs("div", { style: { display: 'flex', gap: 8, marginTop: 6, flexWrap: 'wrap', alignItems: 'center' }, children: [_jsx(StatusBadge, { status: estimateStatus }), _jsxs("select", { value: estimateStatus, onChange: e => saveStatus(e.target.value), style: { fontSize: 12, padding: '2px 6px', border: '1px solid #ccc', borderRadius: 4 }, children: [_jsx("option", { value: "", children: "\u2014 \u0441\u0442\u0430\u0442\u0443\u0441 \u2014" }), ESTIMATE_STATUSES.map(s => _jsx("option", { value: s.value, children: s.label }, s.value))] }), _jsxs("select", { value: docType, onChange: e => saveDocType(e.target.value), style: { fontSize: 12, padding: '2px 6px', border: '1px solid #ccc', borderRadius: 4 }, children: [_jsx("option", { value: "", children: "\u2014 \u0442\u0438\u043F \u0434\u043E\u043A\u0443\u043C\u0435\u043D\u0442\u0430 \u2014" }), DOC_TYPES.map(d => _jsx("option", { value: d, children: d }, d))] })] })] }), _jsxs("div", { style: { display: 'flex', gap: 6, flexWrap: 'wrap', alignItems: 'center' }, children: [_jsx("button", { onClick: () => setShowHistory(true), style: btn('#757575'), children: "\u0418\u0441\u0442\u043E\u0440\u0438\u044F" }), _jsx("button", { onClick: () => setShowOpt(true), style: btn('#ff9800'), children: "\u041E\u043F\u0442\u0438\u043C\u0438\u0437\u0438\u0440\u043E\u0432\u0430\u0442\u044C" }), _jsx("button", { onClick: checkPairs, style: btn('#7b1fa2'), children: "\u041F\u0440\u043E\u0432\u0435\u0440\u0438\u0442\u044C \u043F\u0430\u0440\u044B" }), _jsx("button", { onClick: () => { setShowMove(false); loadProjects(); setShowMove(true); }, style: btn('#00796b'), children: "\u041F\u0435\u0440\u0435\u043C\u0435\u0441\u0442\u0438\u0442\u044C" }), _jsx("button", { onClick: () => { setKpSelected(new Set()); setKpComment(''); setShowKP(true); }, style: btn('#e65100'), children: "\u0417\u0430\u043F\u0440\u043E\u0441 \u041A\u041F" }), _jsx("button", { onClick: () => setShowSepSheet(true), style: btn('#0288d1'), children: "\u0412\u0435\u0434\u043E\u043C\u043E\u0441\u0442\u044C" }), _jsx("button", { onClick: deleteTask, style: btn('#d32f2f'), children: "\u0423\u0434\u0430\u043B\u0438\u0442\u044C" })] })] }), _jsxs("div", { style: { display: 'flex', gap: 8, marginBottom: 8, flexWrap: 'wrap', alignItems: 'center' }, children: [_jsx("span", { style: { fontSize: 13, fontWeight: 600 }, children: "\u0424\u0438\u043B\u044C\u0442\u0440:" }), ['all', 'works', 'materials'].map(t => (_jsx("button", { onClick: () => setFilterType(t), style: { padding: '4px 12px', borderRadius: 4, border: '1px solid #ccc', background: filterType === t ? '#1565c0' : '#fff', color: filterType === t ? '#fff' : '#333', cursor: 'pointer', fontSize: 13 }, children: { all: 'Все', works: 'Работы', materials: 'Материалы' }[t] }, t))), _jsx("input", { value: searchQuery, onChange: e => setSearchQuery(e.target.value), placeholder: "\u041F\u043E\u0438\u0441\u043A \u043F\u043E \u0441\u0442\u0440\u043E\u043A\u0430\u043C...", style: { padding: '4px 10px', border: '1px solid #ccc', borderRadius: 4, fontSize: 13, minWidth: 180 } }), _jsxs("div", { style: { marginLeft: 'auto', display: 'flex', gap: 6 }, children: [_jsx("button", { onClick: () => exportEstimate('all'), style: btn('#2e7d32'), children: "\u2B07 \u0412\u0441\u0435" }), _jsx("button", { onClick: () => exportEstimate('works'), style: btn('#1565c0'), children: "\u2B07 \u0420\u0430\u0431\u043E\u0442\u044B" }), _jsx("button", { onClick: () => exportEstimate('materials'), style: btn('#6a1b9a'), children: "\u2B07 \u041C\u0430\u0442\u0435\u0440\u0438\u0430\u043B\u044B" }), _jsx("button", { onClick: addSection, style: btn('#546e7a'), children: "+ \u0420\u0430\u0437\u0434\u0435\u043B" }), _jsx("button", { onClick: () => setShowAddRow(true), style: btn('#6a1b9a'), children: "+ \u0421\u0442\u0440\u043E\u043A\u0430" })] })] }), selectedIds.size > 0 && (_jsxs("div", { style: { display: 'flex', gap: 8, alignItems: 'center', marginBottom: 8, padding: '8px 12px', background: '#e3f2fd', borderRadius: 6, border: '1px solid #90caf9', flexWrap: 'wrap' }, children: [_jsxs("span", { style: { fontSize: 13, fontWeight: 600 }, children: ["\u0412\u044B\u0431\u0440\u0430\u043D\u043E: ", selectedIds.size] }), _jsx("button", { onClick: batchDelete, style: btn('#d32f2f'), children: "\u0423\u0434\u0430\u043B\u0438\u0442\u044C \u0432\u044B\u0431\u0440\u0430\u043D\u043D\u044B\u0435" }), _jsx("button", { onClick: () => { setBatchSectionTarget(''); setShowBatchSection(true); }, style: btn('#00796b'), children: "\u041F\u0435\u0440\u0435\u043C\u0435\u0441\u0442\u0438\u0442\u044C \u0432 \u0440\u0430\u0437\u0434\u0435\u043B" }), _jsx("button", { onClick: () => { setBatchCoeff('1'); setShowBatchCoeff(true); }, style: btn('#e65100'), children: "\u00D7 \u041A\u043E\u044D\u0444\u0444\u0438\u0446\u0438\u0435\u043D\u0442" }), _jsx("button", { onClick: () => setSelectedIds(new Set()), style: { padding: '6px 12px', border: '1px solid #90caf9', borderRadius: 4, background: '#fff', cursor: 'pointer', fontSize: 13 }, children: "\u0421\u043D\u044F\u0442\u044C \u0432\u044B\u0434\u0435\u043B\u0435\u043D\u0438\u0435" })] })), showBatchSection && (_jsx("div", { style: overlay, children: _jsxs("div", { style: { ...modal, maxWidth: 360 }, children: [_jsx("h3", { style: { margin: '0 0 12px' }, children: "\u041F\u0435\u0440\u0435\u043C\u0435\u0441\u0442\u0438\u0442\u044C \u0432 \u0440\u0430\u0437\u0434\u0435\u043B" }), _jsxs("label", { style: lbl, children: ["\u041D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u0440\u0430\u0437\u0434\u0435\u043B\u0430", _jsx("input", { value: batchSectionTarget, onChange: e => setBatchSectionTarget(e.target.value), style: inp, list: "sections-list" }), _jsx("datalist", { id: "sections-list", children: allSections.map(s => _jsx("option", { value: s }, s)) })] }), _jsxs("div", { style: { display: 'flex', gap: 8, marginTop: 8 }, children: [_jsx("button", { onClick: batchMoveSection, style: btn('#00796b'), children: "\u041F\u0435\u0440\u0435\u043C\u0435\u0441\u0442\u0438\u0442\u044C" }), _jsx("button", { onClick: () => setShowBatchSection(false), style: btn('#757575'), children: "\u041E\u0442\u043C\u0435\u043D\u0430" })] })] }) })), showBatchCoeff && (_jsx("div", { style: overlay, children: _jsxs("div", { style: { ...modal, maxWidth: 360 }, children: [_jsx("h3", { style: { margin: '0 0 12px' }, children: "\u041F\u0440\u0438\u043C\u0435\u043D\u0438\u0442\u044C \u043A\u043E\u044D\u0444\u0444\u0438\u0446\u0438\u0435\u043D\u0442" }), _jsxs("label", { style: lbl, children: ["\u041A\u043E\u044D\u0444\u0444\u0438\u0446\u0438\u0435\u043D\u0442 (\u0446\u0435\u043D\u044B \u0440\u0430\u0431\u043E\u0442 \u0438 \u043C\u0430\u0442\u0435\u0440\u0438\u0430\u043B\u043E\u0432 \u00D7 K)", _jsx("input", { type: "number", min: "0.01", step: "0.01", value: batchCoeff, onChange: e => setBatchCoeff(e.target.value), style: inp })] }), _jsxs("div", { style: { display: 'flex', gap: 8, marginTop: 8 }, children: [_jsx("button", { onClick: batchApplyCoeff, style: btn('#e65100'), children: "\u041F\u0440\u0438\u043C\u0435\u043D\u0438\u0442\u044C" }), _jsx("button", { onClick: () => setShowBatchCoeff(false), style: btn('#757575'), children: "\u041E\u0442\u043C\u0435\u043D\u0430" })] })] }) })), showAddRow && (_jsx("div", { style: overlay, children: _jsxs("div", { style: modal, children: [_jsx("h3", { style: { margin: '0 0 14px' }, children: "\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u0441\u0442\u0440\u043E\u043A\u0443" }), _jsxs("div", { style: { display: 'grid', gap: 8 }, children: [[['Раздел', 'section'], ['Наименование', 'name'], ['Единица измерения', 'unit']].map(([label, key]) => (_jsxs("label", { style: lbl, children: [label, _jsx("input", { value: newRow[key], onChange: e => setNewRow({ ...newRow, [key]: e.target.value }), style: inp })] }, key))), _jsxs("label", { style: lbl, children: ["\u0422\u0438\u043F", _jsxs("select", { value: newRow.type, onChange: e => setNewRow({ ...newRow, type: e.target.value }), style: inp, children: [_jsx("option", { children: "\u0420\u0430\u0431\u043E\u0442\u0430" }), _jsx("option", { children: "\u041C\u0430\u0442\u0435\u0440\u0438\u0430\u043B" })] })] }), [['Количество', 'quantity'], ['Цена работ', 'work_price'], ['Цена материалов', 'mat_price']].map(([label, key]) => (_jsxs("label", { style: lbl, children: [label, _jsx("input", { type: "number", value: newRow[key], onChange: e => setNewRow({ ...newRow, [key]: e.target.value }), style: inp })] }, key)))] }), _jsxs("div", { style: { display: 'flex', gap: 8, marginTop: 14 }, children: [_jsx("button", { onClick: addRow, style: btn('#1976d2'), children: "\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C" }), _jsx("button", { onClick: () => setShowAddRow(false), style: btn('#757575'), children: "\u041E\u0442\u043C\u0435\u043D\u0430" })] })] }) })), _jsxs("div", { style: { display: 'flex', gap: 16, marginBottom: 10, fontSize: 12, color: '#555' }, children: [_jsx("span", { style: { background: '#FFF3CD', padding: '2px 8px', borderRadius: 3 }, children: "\u041E\u043F\u0442\u0438\u043C\u0438\u0437\u0438\u0440\u043E\u0432\u0430\u043D\u043E" }), _jsx("span", { style: { background: '#C8E6C9', padding: '2px 8px', borderRadius: 3 }, children: "\u0410\u043D\u0430\u043B\u043E\u0433" }), _jsx("span", { style: { color: '#888' }, children: "\u0426\u0438\u0444\u0440\u044B \u043A\u043B\u0438\u043A\u0430\u0431\u0435\u043B\u044C\u043D\u044B \u0434\u043B\u044F \u0440\u0435\u0434\u0430\u043A\u0442\u0438\u0440\u043E\u0432\u0430\u043D\u0438\u044F" })] }), _jsx("div", { style: { overflowX: 'auto', marginBottom: 20 }, children: _jsxs("table", { style: { width: '100%', borderCollapse: 'collapse', fontSize: 13 }, children: [_jsx("thead", { children: _jsxs("tr", { style: { background: '#f5f5f5' }, children: [_jsx("th", { style: { padding: '8px 4px', border: '1px solid #e0e0e0', width: 28 }, children: _jsx("input", { type: "checkbox", checked: selectedIds.size > 0 && selectedIds.size === filtered.filter(i => i.row_type !== 'section_header').length, onChange: toggleSelectAll, title: "\u0412\u044B\u0431\u0440\u0430\u0442\u044C \u0432\u0441\u0435" }) }), _jsx("th", { style: { padding: '8px 4px', border: '1px solid #e0e0e0', width: 20 }, title: "\u041F\u0435\u0440\u0435\u0442\u0430\u0449\u0438\u0442\u044C \u0434\u043B\u044F \u043F\u0435\u0440\u0435\u0441\u0442\u0430\u043D\u043E\u0432\u043A\u0438", children: "\u283F" }), ['№', 'Раздел', 'Тип', 'Наименование', 'Ед.', 'Кол-во', 'Цена работ', 'Цена мат.', 'Стоимость', 'Источник', 'Комментарий', ''].map(h => (_jsx("th", { style: { padding: '8px 8px', textAlign: 'left', border: '1px solid #e0e0e0', fontWeight: 600, whiteSpace: 'nowrap' }, children: h }, h)))] }) }), _jsx("tbody", { children: (() => {
