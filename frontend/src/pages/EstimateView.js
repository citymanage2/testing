    ...
    return (_jsxs("div", { style: fullscreen ? { position: 'fixed', inset: 0, zIndex: 200, overflowY: 'auto', background: C.surfaceAlt, padding: '16px 20px' } : { padding: '20px 24px', maxWidth: 1400, margin: '0 auto' }, children: [_jsx("div", { style: { ...CARD, marginBottom: 16, padding: '16px 20px' }, children: _jsxs("div", { style: { display: 'flex', alignItems: 'flex-start', gap: 12, flexWrap: 'wrap' }, children: [_jsxs("div", { style: { flex: 1, minWidth: 200 }, children: [editingName ? (_jsx("input", { ref: nameRef, value: taskName, onChange: e => setTaskName(e.target.value), onBlur: saveName, onKeyDown: e => { if (e.key === 'Enter')
                                        ...
                                        filtered.forEach(item => {
                                            if (item.row_type === 'section_header') {
                                                ...
                                                rows.push(_jsxs("tr", { draggable: true, onDragStart: e => handleDragStart(e, item.id), onDragOver: e => handleDragOver(e, item.id), onDrop: e => handleDrop(e, item.id), onDragLeave: () => setDragOverId(null), style: { background: dragOverId === item.id ? C.primaryBg : C.surfaceAlt, cursor: 'grab' }, children: [_jsx("td", { style: { ...TD, textAlign: 'center' } }), _jsx("td", { style: { ...TD, textAlign: 'center', color: C.textMuted, cursor: 'grab' }, children: "\u283F" }), _jsxs("td", { colSpan: 11, style: { ...TD, fontWeight: 700, fontSize: 13, padding: '6px 10px', color: C.text }, children: [_jsxs("span", { onClick: () => toggleSection(item.id), style: { cursor: 'pointer', userSelect: 'none' }, children: [isCollapsed ? '▶' : '▼', " ", item.name] }), _jsx("button", { onClick: () => deleteItem(item.id), style: { marginLeft: 8, padding: '1px 6px', background: C.dangerBg, color: C.danger, border: `1px solid ${C.dangerBorder}`, borderRadius: 4, cursor: 'pointer', fontSize: 11 }, children: "\u2715" })] })] }, item.id));
                                            }
                                            else {
                                                ...
                                                rows.push(_jsxs("tr", { draggable: true, onDragStart: e => handleDragStart(e, item.id), onDragOver: e => handleDragOver(e, item.id), onDrop: e => handleDrop(e, item.id), onDragLeave: () => setDragOverId(null), style: { background: rowBg, outline: selectedIds.has(item.id) ? `2px solid ${C.primary}` : undefined }, children: [_jsx("td", { style: { ...TD, textAlign: 'center' }, children: _jsx("input", { type: "checkbox", checked: selectedIds.has(item.id), onChange: () => toggleSelect(item.id) }) }), _jsx("td", { style: { ...TD, textAlign: 'center', color: C.textMuted, cursor: 'grab' }, children: "\u283F" }), _jsx("td", { style: TD, children: item.position }), _jsx("td", { style: TD, children: item.section }), _jsx("td", { style: TD, children: item.type }), _jsxs("td", { style: { ...TD, maxWidth: 280 }, children: [item.name, item.is_analogue && _jsx("span", { style: { marginLeft: 6, padding: '1px 5px', background: C.success, color: '#fff', borderRadius: 10, fontSize: 10 }, children: "\u0430\u043D\u0430\u043B\u043E\u0433" }), item.is_optimized && _jsx("span", { style: { marginLeft: 4, padding: '1px 5px', background: C.warning, color: '#fff', borderRadius: 10, fontSize: 10 }, children: "\u043E\u043F\u0442" })] }), _jsx("td", { style: TD, children: item.unit }), _jsx("td", { style: { ...TD, minWidth: 60 }, children: editInput(item, 'quantity') }), _jsx("td", { style: { ...TD, minWidth: 80 }, children: editInput(item, 'work_price') }), _jsx("td", { style: { ...TD, minWidth: 80 }, children: editInput(item, 'mat_price') }), _jsx("td", { style: TD, children: fmt(item.total) }), _jsx("td", { style: { ...TD, minWidth: 120 }, children: item.type === 'Материал' && (item.source_url
                                                                ? _jsxs("a", { href: item.source_url, target: "_blank", rel: "noopener noreferrer", style: { fontSize: 11, color: C.primary, wordBreak: 'break-all' }, children: ["\uD83D\uDD17 ", item.source_url.replace(/^https?:\/\//, '').slice(0, 25), "\u2026"] })
                                                                : editInput(item, 'source_url')) }), _jsx("td", { style: { ...TD, minWidth: 120 }, children: editInput(item, 'comment') }), _jsx("td", { style: TD, children: _jsxs("div", { style: { display: 'flex', gap: 4 }, children: [item.type === 'Материал' && (_jsx("button", { onClick: () => setAnalogueItemId(item.id), style: { padding: '2px 8px', background: C.primaryBg, color: C.primary, border: `1px solid ${C.primary}33`, borderRadius: 4, cursor: 'pointer', fontSize: 11 }, children: "\u0410\u043D\u0430\u043B\u043E\u0433\u0438" })), _jsx("button", { onClick: () => saveItemToCatalog(item.id), title: "\u0421\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u044C \u0432 \u043A\u0430\u0442\u0430\u043B\u043E\u0433", style: { padding: '2px 7px', background: C.successBg, color: C.success, border: `1px solid ${C.success}40`, borderRadius: 4, cursor: 'pointer', fontSize: 11 }, children: "\uD83D\uDCCB" }), _jsx("button", { onClick: () => deleteItem(item.id), style: { padding: '2px 6px', background: C.dangerBg, color: C.danger, border: `1px solid ${C.dangerBorder}`, borderRadius: 4, cursor: 'pointer', fontSize: 11 }, children: "\u2715" })] }) })] }, item.id));
                                            }
                                        });
                                        return rows;
