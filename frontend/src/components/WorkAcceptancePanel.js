                        ...
                        return (_jsxs("div", { style: {
                                ...
                                overflow: 'hidden',
                                        ...
                                        background: isExpanded ? C.primaryBg : C.surface,
                                                ...
                                                updateStatus(acc.id, next);
                                            }, children: updatingStatus === acc.id ? '...' : '⟳' }), _jsx("button", { style: btnDanger('sm'), disabled: deletingAcc === acc.id, title: "\u0423\u0434\u0430\u043B\u0438\u0442\u044C \u0430\u043A\u0442", onClick: () => deleteAcceptance(acc.id), children: deletingAcc === acc.id ? '...' : '✕' })] }), isExpanded && (_jsxs("div", { style: { borderTop: `1px solid ${C.border}` }, children: [_jsx("div", { children: _jsxs("table", { style: { width: '100%', borderCollapse: 'collapse', tableLayout: 'fixed' }, children: [_jsxs("colgroup", { children: [_jsx("col", {}), _jsx("col", { style: { width: 52 } }), _jsx("col", { style: { width: 90 } }), _jsx("col", { style: { width: 110 } }), _jsx("col", { style: { width: 80 } })] }), _jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { style: { ...TH }, children: "\u041D\u0430\u0438\u043C\u0435\u043D\u043E\u0432\u0430\u043D\u0438\u0435" }), _jsx("th", { style: { ...TH, textAlign: 'center' }, children: "\u0415\u0434." }), _jsx("th", { style: { ...TH, textAlign: 'right' }, children: "\u0412\u0441\u0435\u0433\u043E \u0432 \u0441\u043C\u0435\u0442\u0435" }), _jsx("th", { style: { ...TH, textAlign: 'right' }, children: "\u041F\u0440\u0438\u043D\u044F\u0442\u043E" }), _jsx("th", { style: { ...TH, textAlign: 'right' }, children: "\u041E\u0441\u0442\u0430\u0442\u043E\u043A" })] }) }), _jsx("tbody", { children: rows.length > 0
                                                            ? rows.map((row) => {
                                                            ...
                                                            }) })] }) }), _jsxs("div", { style: { display: 'flex', gap: 8, padding: '10px 12px', borderTop: `1px solid ${C.border}`, background: C.surfaceAlt }, children: [_jsx("button", { style: btnPrimary('sm'), disabled: savingItems === acc.id, onClick: () => saveAccItems(acc.id), children: savingItems === acc.id ? 'Сохранение...' : 'Сохранить позиции' }), _jsx("button", { style: btnOutline('sm'), onClick: async () => {
                                                        try {
                                                            const resp = await client.get(`${base}/acceptances/${acc.id}/export-ks2`, { responseType: 'blob' });
                                        ...
                                        return (_jsxs("tr", { children: [_jsx("td", { style: TD, children: p.item_name }), _jsx("td", { style: { ...TD, textAlign: 'center', color: C.textSec }, children: p.unit }), _jsx("td", { style: { ...TD, textAlign: 'right' }, children: p.quantity_total }), _jsx("td", { style: { ...TD, textAlign: 'right' }, children: p.quantity_accepted }), _jsx("td", { style: { ...TD, textAlign: 'right', color: p.quantity_remaining > 0 ? C.textSec : C.success }, children: p.quantity_remaining }), _jsx("td", { style: TD, children: _jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: 6 }, children: [_jsx("div", { style: {
                                                                    ...
                                                                    } }) }), _jsxs("span", { style: { fontSize: 11, color: barColor, fontWeight: 600, minWidth: 32, textAlign: 'right' }, children: [pct.toFixed(0), "%"] })] }) })] }, p.item_id));
                                    }) })] }) }))] })] }));
}
